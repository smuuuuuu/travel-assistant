package com.itbaizhan.travelfile.utils;
...
@Slf4j
@Component
@RequiredArgsConstructor //给所有final字段添加构造器， 提供MinioClient注入
public class MinioUtils {
     ...
     */
    /*@SneakyThrows(Exception.class)
    public void removeFolder(String bucketName, String objectName) {
     ...
     */
    public String getDownloadUrlByPath(String bucketName,String objectKey, String fileName, Integer expires) {
       String url;
        try {
            ...
            throw new BusException(CodeEnum.TRIP_NO_FOUND_FILE);
        }
        return url;
    }
    ...
    public ObjectWriteResponse copyFile(String bucketName, String objectName, String srcBucketName, String srcObjectName) {
        return minioClient.copyObject(CopyObjectArgs.builder()
                .source(CopySource.builder().bucket(bucketName)
    ...
    public String getPresignedObjectUrl(String bucketName, String objectName, Integer expires) {
        GetPresignedObjectUrlArgs args = GetPresignedObjectUrlArgs.builder().
                expiry(expires).bucket(bucketName).object(objectName).method(Method.GET).build();
